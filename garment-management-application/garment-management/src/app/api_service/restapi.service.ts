...
export class RestapiService {
  ...
  deleteCatalogUrl = "http://localhost:3000/deleteCatalog";
  ...
  getOrderUrl = "http://localhost:3000/getoid";
  ...
  deleteCatalog(cid:any)
  {
    return this.http.post<any>(this.deleteCatalogUrl,cid);
  }
